                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-inner">
                        ...
                        <?php else : ?>
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item active">
                                    <img class="d-block w-100" alt="First slide"
                                         src= <?php echo $images_for_page_by_slug[0] ?>
                                    <div class="carousel-caption d-none d-md-block">
                                        <p onload="fitCaptionText()">Caption for slide 1</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" alt="Second slide"
                                         src= <?php echo $images_for_page_by_slug[1] ?>
                                    <div class="carousel-caption d-none d-md-block">
                                        <p onload="fitCaptionText()">Caption for slide 2</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" alt="Third slide"
                                         src= <?php echo $images_for_page_by_slug[2] ?>
                                    <div class="carousel-caption d-none d-md-block">
                                        <p onload="fitCaptionText()">Caption for slide 3</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" alt="Forth slide"
                                         src= <?php echo $images_for_page_by_slug[3] ?>
                                    <div class="carousel-caption d-none d-md-block">
                                        <p onload="fitCaptionText()">...</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" alt="Fifth slide"
                                         src= <?php echo $images_for_page_by_slug[4] ?>
                                    <div class="carousel-caption d-none d-md-block">
                                        <p onload="fitCaptionText()">...</p>
                                    </div>
                                </div>
                            ...
                            <a class="carousel-control-prev" href="#carousel" role="button" onclick="slideLeft()"
                               data-slide="prev">
